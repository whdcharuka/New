...
const Wrapper = () => {
  const data = [
    {
      path:"./Vp1",
      cateImg: "/images/HobbySport/5.jpg",
      title: "Horn ",
      brand:"Apple",
      model:"single",
    ...
    {
      path:"./Vp2",
      cateImg: "/images/HobbySport/6.jpg",
      title: "Air filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    {
      path:"./Vp3",
      cateImg: "/images/HobbySport/7.jpg",
      title: "Fuel filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    // {
    //   path:"./Vp4",
    //   cateImg: "/images/HobbySport/8.jpg",
    //   title: "Oil filter ",
    //   brand:"Apple",
    //   model:"single",
    //   decs: "You can use decorate your table Table suitable",
  ...
  return (
    <>
    <Navbar/>
    <h1 className='qwe3'>Travelling Items</h1>
    <Categories/>
      <HsCategories/>
