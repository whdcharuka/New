...
const Wrapper = () => {
  const data = [
    {
      path:"./Vp1",
      cateImg: "/images/Education/21.jpg",
      title: "Horn ",
      brand:"Apple",
      model:"single",
    ...
    {
      path:"./Vp2",
      cateImg: "/images/Education/22.jpg",
      title: "Air filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    {
      path:"./Vp3",
      cateImg: "/images/Education/23.jpg",
      title: "Fuel filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    // {
    //   path:"./Vp4",
    //   cateImg: "/images/Education/24.jpg",
    //   title: "Oil filter ",
    //   brand:"Apple",
    //   model:"single",
    //   decs: "You can use decorate your table Table suitable",
  ...
  return (
    <>
    <Navbar/>
    <h1 className='qwe3'>Note Books</h1>
    <Categories/>
      <EdCategories/>
