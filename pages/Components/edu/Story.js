...
const Wrapper = () => {
  const data = [
    {
      path:"./Vp1",
      cateImg: "/images/Education/13.jpg",
      title: "Horn ",
      brand:"Apple",
      model:"single",
    ...
    {
      path:"./Vp2",
      cateImg: "/images/Education/14.jpg",
      title: "Air filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    {
      path:"./Vp3",
      cateImg: "/images/Education/15.jpg",
      title: "Fuel filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    // {
    //   path:"./Vp4",
    //   cateImg: "/images/Education/16.jpg",
    //   title: "Oil filter ",
    //   brand:"Apple",
    //   model:"single",
    //   decs: "You can use decorate your table Table suitable",
  ...
  return (
    <>
    <Navbar/>
    <h1 className='qwe3'>Story Books</h1>
    <Categories/>
      <EdCategories/>
