...
const Wrapper = () => {
  const data = [
    {
      path:"./Vp1",
      cateImg: "/images/vehicalparts/9.jpg",
      title: "Horn ",
      brand:"Apple",
      model:"single",
    ...
    {
      path:"./Vp2",
      cateImg: "/images/vehicalparts/10.jpg",
      title: "Air filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    {
      path:"./Vp3",
      cateImg: "/images/vehicalparts/11.jpg",
      title: "Fuel filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    // {
    //   path:"./Vp4",
    //   cateImg: "/images/vehicalparts/12.jpg",
    //   title: "Oil filter ",
    //   brand:"Apple",
    //   model:"single",
    //   decs: "You can use decorate your table Table suitable",
